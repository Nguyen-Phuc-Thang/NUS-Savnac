...
export default function CoursePage() {
  ...
  const getCourseData = async () => {
    try {
      ...
      toast.error(
        error.message || "Failed to fetch course data. Please try again later.",
      );
    }
  };
  ...
  const getAllFolders = async (courseId: string) => {
    try {
      ...
      toast.error(
        error.message || "Failed to fetch folders. Please try again later.",
      );
    }
  };
  ...
  const handleCreateFolder = async () => {
    try {
      ...
      toast.error(
        error.message || "Failed to create folder. Please try again later.",
      );
    } finally {
  ...
  const handleUpdateFolder = async () => {
    try {
      ...
      toast.error(
        error.message || "Failed to update folder. Please try again later.",
      );
    } finally {
  ...
  const handleDeleteFolder = async () => {
    try {
      ...
      setFolders(
        folders.filter((folder) => folder.folderId !== selectedFolder.folderId),
      );
      toast.success("Folder " + selectedFolder.name + " deleted successfully!");
    } catch (error: any) {
      toast.error(
        error.message || "Failed to delete folder. Please try again later.",
      );
    } finally {
  ...
  const handleCreateLink = async () => {
    try {
      ...
      toast.error(
        error.message || "Failed to create link. Please try again later.",
      );
    }
  };
  ...
  const handleUpdateLink = async () => {
    try {
      ...
      toast.error(
        error.message || "Failed to update link. Please try again later.",
      );
    } finally {
  ...
  const handleDeleteLink = async () => {
    try {
      ...
      toast.error(
        error.message || "Failed to delete link. Please try again later.",
      );
    } finally {
  ...
  const addNewTask = async (taskType: "WEEKLY" | "TODAY", taskName: string) => {
    try {
      ...
      toast.error(
        error.message || "Failed to create task. Please try again later.",
      );
    }
  };
      ...
      <main className="flex min-w-0 flex-1 flex-col gap-4 ml-6 mt-6">
          ...
          <div>
            ...
            <section className="mt-5">
              ...
              <div className="mt-2 font-sans text-muted-foreground">
                <p>
                  Exam Date:{" "}
                  {formatToMonthDayYear(courseData?.semesterData[1].examDate)}
                </p>
              </div>
        ...
        <section>
          ...
          <div className="mt-4 flex flex-row items-center gap-4">
            ...
            <Button
              onClick={() =>
                setFolderGridMode(switchMode(folderGridMode, "EDIT"))
              }
            ...
            <Button
              onClick={() =>
                setFolderGridMode(switchMode(folderGridMode, "DELETE"))
              }
        ...
        <section className="mt-10">
          ...
          <div className="mt-4 flex flex-row items-center gap-4">
            ...
            <Button
              onClick={() => setLinkGridMode(switchMode(linkGridMode, "EDIT"))}
            ...
            <Button
              onClick={() =>
                setLinkGridMode(switchMode(linkGridMode, "DELETE"))
              }
