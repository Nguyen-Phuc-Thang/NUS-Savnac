...
export default function TaskList({
    ...
    const saveEditingTask = (taskId: string) => {
        ...
        if (
            nextName &&
            nextName !== tasks.find((task) => task.taskId === taskId)?.name
        ) {
            ...
            {isEntering ? (
                <div className="flex flex-col items-start">
                    <div className="flex flex-row items-center justify-center mt-2">
                        ...
                        />
                        <Button
                            className="ml-1 rounded-md bg-white hover:bg-white text-black"
                ...
                <Button
                    className="mt-2 border rounded-md bg-white hover:bg-white text-black"
